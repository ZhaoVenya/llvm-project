...
>>>>>>>> cmake -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_C_COMPILER=clang -DCMAKE_BUILD_TYPE=Debug -DLLVM_OPTIMIZED_TABLEGEN=ON -DLLVM_TARGETS_TO_BUILD="X86;Mips;RISCV" -DLLVM_EXPERIMENTAL_TARGETS_TO_BUILD="Day" -DCMAKE_LINKER=ld.lld -DBUILD_SHARED_LIBS=ON -DLLVM_ENABLE_PROJECTS="clang;lld" -G "Ninja" ../llvm
